...
const ManageYourAccPage = () => {
  ...
  const handlePasswordSubmit = (e) => {
    ...
    const url = `https://my-app-backend-dusky.vercel.app/fb/manage-account-password/${address_id}?password=${encodeURIComponent(
      password
    )}`;
    fetch(url)
      .then((res) => {
  ...
  useEffect(() => {
    ...
    const fillUrl = `https://my-app-backend-dusky.vercel.app/fb/select-to-manage/${address_id}?password=${encodeURIComponent(
      password
    )}`;
    fetch(fillUrl)
      .then((res) => {
  ...
  const handleManageSubmit = (e) => {
    ...
    if (actionType === "delete") {
      ...
      const url = `https://my-app-backend-dusky.vercel.app/fb/manage-account-delete/${address_id}`;
      if (confirm) {
        setIsDeleting(true);
    ...
    if (actionType === "update") {
      const updateUrl = `https://my-app-backend-dusky.vercel.app/fb/manage-account-update/${address_id}`;
      const updateData = {
